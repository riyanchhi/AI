""" 8 Puzzle Iterative Deepening Search algorithm Input the unsolved puzzle and the program solves it and creates 3 txt files with solutions"""
...
Enter the 8 number: 6
Enter the 9 number: 5
